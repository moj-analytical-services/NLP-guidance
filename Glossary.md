...
### <a name="cossim"></a> Cosine similarity
...
### <a name="idf"></a> Inverse Document Frequency (IDF) weighting
...
### <a name="tdm"></a> Term-document matrix (TDM)
...
### <a name="weighting"></a> Weighting scheme
